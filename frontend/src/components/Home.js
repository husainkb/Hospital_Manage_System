    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-red-600">Hospital Management System</span>
        </div>
      ...
      <main className="flex-1">
        <Section bg="bg-red-600" height="min-h-[30rem]">
        ...
        <Section bg="bg-gray-100" height="min-h-[25rem]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-4 text-left text-red-600">Modernize Your Hospital Operations</h2>
