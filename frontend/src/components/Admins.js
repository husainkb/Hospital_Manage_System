...
const CardHeader = ({ children, icon: Icon }) => (
  <div className="px-4 py-5 border-b border-gray-200 sm:px-6 flex items-center justify-between">
    {children}
    {Icon && <Icon className="h-5 w-5 text-red-600 ml-2" />}
  </div>
);
...
const Input = ({ ...props }) => (
  <input
    className="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md px-1 h-6"
    {...props}
  />
);
...
const Select = ({ children, ...props }) => (
  <select
    className="mt-1 block w-full pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md"
    {...props}
  >
    {children}
  </select>
    ...
    <div className="min-h-screen bg-red-600">
      <header className="bg-white p-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <img src='logo1.png' alt='' className='w-20 h-16'/>
        ...
        <ul className="flex space-x-4 justify-center">
          <li>
            <Button
              ...
              className={`hover:bg-white hover:text-red-600 ${activeTab === 'Dashboard' ? 'bg-white text-red-600' : 'text-white'}`}
          ...
          <li>
            <Button
              ...
              className={`hover:bg-white hover:text-red-600 ${activeTab === 'Profile' ? 'bg-white text-red-600' : 'text-white'}`}
          ...
          <li>
            <Button
              ...
              className={`hover:bg-white hover:text-red-600 ${activeTab === 'Add Doctor' ? 'bg-white text-red-600' : 'text-white'}`}
          ...
          <li>
            <Button
              ...
              className={`hover:bg-white hover:text-red-600 ${activeTab === 'Add Admin' ? 'bg-white text-red-600' : 'text-white'}`}
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-white mb-8">
          Welcome, {adminInfo ? `${adminInfo.firstName} ${adminInfo.lastName}` : 'Admin'}
        </h1>
